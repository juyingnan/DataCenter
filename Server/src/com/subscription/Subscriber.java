...
public class Subscriber
{
	...
	private void syncSubDatabase()
	{
		...
		for (MetaDataSub metaDataSub : subList)
		{
			...
			String sql1 = "select * from t_metadata_def where id='" + metaDataSub.getDefID() + "'";
	...
	{
		String sql1 = "select * from t_metadata_def where tableName='" + tableName + "'";
		System.out.println(sql1);
		ArrayList<MetaDataDef> return1 = MetaDataReader.readDefDatabase(sql1);
		if (!return1.isEmpty())
		{
