...
public class DIFServiceImpl implements Iface {
	...
	private final int AFFAIR_BEGIN = 2;
	...
	public Map<String, String> dataBaseConn(Map<String, String> mappara)
			throws TException {
		logger.info("DIFServiceImpl:Begin dataBaseConn method." + TimeRecord.CurrentCompleteTime());
		...
		logger.info("DIFServiceImpl:dataBaseConn method success" + TimeRecord.CurrentCompleteTime());		
		return resMap;
	}

	public void dataOperAffair(Map<String, String> mappara) {
		addTask(mappara);
	}

	private synchronized void addTask(Map<String, String> mappara) {
		// TODO Auto-generated method stub
		logger.info("come into function addTask of class DIFServiceImpl");
		System.out
		...
		// add cong
		/*
		 * 目前存在一个bug，当affairbegin开启一共线程后，执行call方法时，
		...
		logger.info("leave off function addTask of class DIFServiceImpl");
	}
	...
	public Map<String, String> affairBegin(Map<String, String> mappara)
			throws TException {
		// TODO Auto-generated method stub
		logger.info("come into function affairBegin of class DIFServiceImpl");
		...
		result = ThreadPool.getThreadPool().submit(
				new WorkThread(AFFAIR_BEGIN, mappara));
		resMap.put(TransactionID, transactionIdStr);
		resMap.put("res", "success");

		logger.info("leave off function affairBegin of class DIFServiceImpl");
		return resMap;
	}
	...
	public Map<String, String> affairCommit(Map<String, String> mappara)
			throws TException {
		logger.info("come into function affairCommit of class DIFServiceImpl");
		// TODO Auto-generated method stub
		// System.out.println("in method affairCommit");
		// System.out.println("mappara ID = "+mappara.get("ID"));
		// printTranIDandOrder(mappara);
		// Map<String,String> resMap = new HashMap<String,String>();
		// resMap.put("res", "affairCommit123456");
