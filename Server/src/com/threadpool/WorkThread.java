...
//			ThreadObjectSession.Set(mappara.get("ID"), object);
			...
			result = serverAgent.dealWithAffairBegin(mappara);
		break;
		case 3: result = serverAgent.dealWithAffairCommit(mappara);
		break;
		case 4: result = serverAgent.dealWithAffairRollBack(mappara);
		break;
		case 5: result = serverAgent.dealWithAffairEnd(mappara);
		break;
